...
@section('content')
    ...
    <h2 class="text-slate-700 font-bold p-4 ml-2 mt-4 text-3xl">Edit Data User</h2>
    <div class="p-5">
        <div class="block p-6 rounded-lg shadow-lg bg-slate-100 max-w-sm">
            <form action="{{ route('updateuser') }}" method="POST">
              ...
              <div class="form-group mb-4">
                ...
                <input type="text" class="form-control
                  ...
                  id="nama" name="nama" placeholder="Nama" value="{{$user->Name}}">
              </div>
              <div class="form-group mb-4">
              ...
              <div class="form-group mb-4">
                ...
                <div class="relative">
                  <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" 
                    id="status" name="status" value="{{$user->Status}}">
                    <option value="1" {{($user->Status === 1) ? 'Selected' : ''}}>Admin</option>
                    <option value="2" {{($user->Status === 2) ? 'Selected' : ''}}>User</option>
                  </select>
            ...
            <a href="{{url('/user')}}"><button class="p-2 my-3 bg-red-900 rounded-md text-white
